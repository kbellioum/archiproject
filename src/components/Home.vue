  ...
  mounted () {
    setTimeout(() => {
      this.list = [
        ...
        { backgroundColor: '#f44336', width: '100%', height: '100%', src: 'https://res.cloudinary.com/kbellioum/image/upload/v1516033951/Adrchiproject/plan_de_masse_-AD.jpg', background: 'url(\'https://res.cloudinary.com/kbellioum/image/upload/v1516033951/Adrchiproject/plan_de_masse_-AD.jpg\') no-repeat center center', backgroundSize: '100% 100%', title: 'Victoria City' },
        { backgroundColor: '#f44336', width: '100%', height: '100%', src: 'https://res.cloudinary.com/kbellioum/image/upload/v1516034128/Adrchiproject/spa-27.jpg', background: 'url(\'https://res.cloudinary.com/kbellioum/image/upload/v1516034128/Adrchiproject/spa-27.jpg\') no-repeat center center', backgroundSize: '100% 100%', title: 'Clinique GUESS' },
        { backgroundColor: '#f44336', width: '100%', height: '100%', src: 'https://res.cloudinary.com/kbellioum/image/upload/v1516035303/Adrchiproject/img-slider-2.jpg', background: 'url(\'https://res.cloudinary.com/kbellioum/image/upload/v1516035303/Adrchiproject/img-slider-2.jpg\') no-repeat center center', backgroundSize: '100% 100%', title: 'Morocco Mall' },
        { backgroundColor: '#f44336', width: '100%', height: '100%', src: 'https://res.cloudinary.com/kbellioum/image/upload/v1516035302/Adrchiproject/img-slider-3.jpg', background: 'url(\'https://res.cloudinary.com/kbellioum/image/upload/v1516035302/Adrchiproject/img-slider-3.jpg\') no-repeat center center', backgroundSize: '100% 100%', title: 'CIH' },
