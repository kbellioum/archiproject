<template>
  <div class="home" height="100vh">
    ...
    <!-- <div class="image1">
      <img src="../assets/images/urbanisme/image01.png" alt="">
    </div>
    <div class="image2">
      <img src="../assets/images/urbanisme/image02.png" alt="">
    </div>
    <div class="image3">
...
@media screen and (min-height:200px) and (max-height:730px) {
  .accordion ul li div {
    display: block;
    overflow: hidden;
    width: 100%;
